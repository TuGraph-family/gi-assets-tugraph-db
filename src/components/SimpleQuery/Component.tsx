...
const SimpleQuery = () => {
  ...
  const { graph, assets, data } = useContext();
  ...
  const handleTypeChange = value => {
    console.log(value, assets, data, graph.save());
    setState(draft => {
          ...
          return {
            ...
            text: (
              <Row style={{ paddingTop: 4 }}>
                ...
                <Col span={6}>
                  <Tag>
                    <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 55 }}>{d.propertyKey}</div>
                  </Tag>
                </Col>
                <Col span={1}></Col>
                <Col span={10}>
                  <Tag>
                    <div style={{ overflow: 'hidden', textOverflow: 'ellipsis', maxWidth: 90 }}>{d.value}</div>
                  </Tag>
                </Col>
              </Row>
            ),
  ...
  return (
    <div className="simpleQueryContainer">
      <Form form={form} className="quickQueryForm" layout="vertical" style={{ height: '100%', overflow: 'auto' }}>
        <Form.Item>
          <Input.Group compact>
